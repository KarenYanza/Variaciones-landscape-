...
public class ActivityMainBindingLandImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.magnitud, 1);
        sViewsWithIds.put(R.id.imageView, 2);
        sViewsWithIds.put(R.id.txt_latitud, 3);
        sViewsWithIds.put(R.id.txt_longitud, 4);
        sViewsWithIds.put(R.id.txt_ric, 5);
        sViewsWithIds.put(R.id.latitud, 6);
        sViewsWithIds.put(R.id.longitud, 7);
        sViewsWithIds.put(R.id.txt_datos, 8);
        sViewsWithIds.put(R.id.txt_datos2, 9);
